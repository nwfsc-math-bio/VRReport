...
```{r}
#| fig-cap: Map of the Upper steelhead DPS's spawning and rearing areas, illustrating populations and major population groups.
#| label: fig-UCR-steelhead-spawning-areas
knitr::include_graphics(here::here("media", "image14.jpg"))
```
...
#| label: fig-UC-steelhead-smoothed-trends
#| fig-subcap: 
#|   - "Traditionally generated spawner abundance"
#|   - "PIT tag based"
#| layout-nrow: 2
knitr::include_graphics(here::here("media", "image16.jpg"))
knitr::include_graphics(here::here("media", "image17.jpg"))
```

```{r}
#| fig-cap: Estimate spawners relative to observed spawners across all four populations for all years where both measures exist. Black line represents the expected 1:1 relationship if the run-at-large tagging based, model estimated population measures match the current redd survey based measures.
#| label: fig-UC-steelhead-one-to-one
knitr::include_graphics(here::here("media", "image18.png"))
```
...
#| label: fig-UC-Spr-Chinook-productivity-trends
knitr::include_graphics(here::here("media", "image19.png"))
```
...
#| label: fig-UC-Spr-Chinook-Smolt-to-Adult-Productivity
knitr::include_graphics(here::here("media", "image20.png"))
```
...
#| label: fig-UC-steelhead-smoothed-frac-wild
knitr::include_graphics(here::here("media", "image21.png"))
```
